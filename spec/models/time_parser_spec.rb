  ...
  describe "parse addresses" do
    ...
    context "minutes" do
      it "should detect the minutes" do
        ...
        EmailParser::IncrementalTime.parse_email(email).should == 2.minutes.from_now
      end

      it "should detect the minutes (m) (complex)" do
        email = "5m@sorad.cc"
        EmailParser::IncrementalTime.parse_email(email).should == 5.minutes.from_now
      end
    ...
    context "hours" do
      it "should detect the hours" do
        ...
        EmailParser::IncrementalTime.parse_email(email).should == 2.hours.from_now
      end

      it "should detect the days (complex)" do
        email = "5h@sorad.cc"
        EmailParser::IncrementalTime.parse_email(email).should == 5.hours.from_now
      end
    end
    ...
    context "days" do
      it "should detect the days" do
        ...
        EmailParser::IncrementalTime.parse_email(email).should == 2.days.from_now
      end

      it "should detect the days (complex)" do
        email = "5d@sorad.cc"
        EmailParser::IncrementalTime.parse_email(email).should == 5.days.from_now
      end
    end
    ...
    context "weeks" do
      it "should detect the weeks" do
        ...
        EmailParser::IncrementalTime.parse_email(email).should == 2.weeks.from_now
      end

      it "should detect the weeks (complex)" do
        email = "5w@sorad.cc"
        EmailParser::IncrementalTime.parse_email(email).should == 5.weeks.from_now
      end
    end
    ...
    context "months" do
      it "should detect the months" do
        ...
        EmailParser::IncrementalTime.parse_email(email).should == 2.months.from_now
      end

      it "should detect the months (complex)" do
        email = "5mo@sorad.cc"
        EmailParser::IncrementalTime.parse_email(email).should == 5.months.from_now
      end
    end
    ...
    context "years" do
      it "should detect the years" do
        ...
        EmailParser::IncrementalTime.parse_email(email).should == 2.years.from_now
      end

      it "should detect the years (complex)" do
        email = "5y@sorad.cc"
        EmailParser::IncrementalTime.parse_email(email).should == 5.years.from_now
      end
    end
    ...
    context "combined" do
      it "should detect everything" do
        ...
        EmailParser::IncrementalTime.parse_email(email).should == (2.years + 3.months + 12.days +
